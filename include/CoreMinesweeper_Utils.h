...
#define COW_COREMINESWEEPER_VERSION_REVISION "2"

#define COW_COREMINESWEEPER_VERSION       \
    COW_COREMINESWEEPER_VERSION_MAJOR "." \
    COW_COREMINESWEEPER_VERSION_MINOR "." \
    COW_COREMINESWEEPER_VERSION_REVISION
